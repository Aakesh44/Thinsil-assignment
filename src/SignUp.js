    ...
    <form className=' w-4/5 sm:w-2/3 lg:w-1/3 mx-auto p-5 mt-10 mb-20 text-xs font-semibold flex flex-col justify-around border rounded-sm bg-cyan-2000'>
      ...
      <header className='w-full my-5 mb-10 text-2xl font-bold text-center '>
        ...
        <div className='h-20 flex flex-col justify-around mb-4'>
          ...
          <input required type="text" id='name' className='w-full mx-auto focus:outline-1 outline-pink-500 border h-10 rounded-md text-sm font-semibold px-3 bg-gray-50 border-gray-200' placeholder='Coupon code'/>
        </div>
        ...
        <div className='h-20 flex flex-col justify-around mb-4'>
          ...
          <input required type="password" id='cpassword' className='w-full mx-auto focus:outline-1 outline-pink-500 border h-10 rounded-md text-sm font-semibold px-3 bg-gray-50 border-gray-200' placeholder='Coupon code'/>
        </div>   
